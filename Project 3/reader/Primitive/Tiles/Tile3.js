...
function Tile3(scene, id, player) {
...
Tile3.prototype = Object.create(CGFobject.prototype);
Tile3.prototype.constructor = Tile3;

Tile3.prototype.display = function () {
    if(this.selectable)
    ...
    this.scene.pushMatrix();
        this.scene.translate(0.42,0.4,0.05); //left
        this.scene.rotate(Math.PI/2*this.direction, 0, 0, 1);
    ...
    this.scene.pushMatrix();
        this.scene.translate(0.42,0.4,0.05); //up
        this.scene.rotate(Math.PI/2*(this.direction-1), 0, 0, 1);
        this.scene.translate(0,-0.2,0);
        this.scene.rotate(Math.PI/2, 1, 0, 0);
        this.arrowApp.apply();
        this.arrow.display();
    ...
    this.scene.pushMatrix();
        this.scene.translate(0.42,0.42,0.05); //down
        this.scene.rotate(Math.PI/2*(this.direction+1), 0, 0, 1);
        this.scene.translate(0,-0.2,0);
        this.scene.rotate(Math.PI/2, 1, 0, 0);
        this.arrowApp.apply();
